#The program creates a basic white board for drawing
...
#eraser, cleans the entire canvas
...
#Slider for setting the line thickness
...
#label value showing thickness in digits
